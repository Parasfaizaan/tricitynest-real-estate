    ...
    <SiteShell taxonomies={{ locations, propertyTypes: types }}>
      <article className="container-px max-w-3xl pt-28 pb-20">
        ...
        <p className="mt-6 text-ink-soft leading-relaxed">
          TricityNest collects name, phone, email and property preferences only to match listings and respond to enquiries. We do not sell personal data. You may request deletion of a lead by writing to hello@tricitynest.com.
        </p>
      </article>
    </SiteShell>
  );
