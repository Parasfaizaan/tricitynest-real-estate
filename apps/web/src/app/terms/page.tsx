    ...
    <SiteShell taxonomies={{ locations, propertyTypes: types }}>
      <article className="container-px max-w-3xl pt-28 pb-20">
        ...
        <p className="mt-6 text-ink-soft leading-relaxed">
          Listings on tricityinvestment are indicative. Prices, availability and area may change. Site visits are by appointment. tricityinvestment is an advisory and is not a party to the sale unless separately contracted.
        </p>
      </article>
    </SiteShell>
  );
